...
delayline_alloc(DelayLine *d, sample_t max_delay) {
...
static void 
delayline_init(DelayLine *d, sample_t feedback, sample_t delay)
{
    d->counter=0;
    d->delay = delay;
    d->feedback = feedback;
...
delayline_feed(DelayLine* d, sample_t in)
{        
...
__attribute__((unused)) 
static void 
delay_init(Delay *d, sample_t feedback, sample_t delay)
{
    d->counter=0;
    d->delay = delay;
    d->feedback = feedback;
...
__attribute__((unused)) static void
delay_alloc(Delay *d, sample_t max_delay, sample_t fs) {
...
__attribute__((unused)) static void 
delay_update(Delay* d, sample_t feedback, sample_t delay, uint32_t len)
{
    d->feedback = feedback;
...
__attribute__((unused)) 
static inline sample_t 
delay_feed(Delay* d, sample_t in)
{   
    sample_t out;
    if (d->cf_cnt) 
    {
