...
static inline void 
adsr_init(Adsr* self, sample_t attack, sample_t decay, sample_t sustain
        , sample_t release, sample_t sampleRate)
{
...
static inline void 
adsr_loop(Adsr* self, int loop) {
    self->loop = loop;
}
static inline sample_t 
adsr_process(Adsr* self) 
{
    switch (self->state) {
        case adsr_idle:
            self->output = 0.0;
...
static inline void 
adsr_setAttackRate(Adsr* self, sample_t rate) 
{
...
static inline void 
adsr_setDecayRate(Adsr* self, sample_t rate) 
{
    self->decayRate = rate;
...
static inline void 
adsr_setReleaseRate(Adsr* self, sample_t rate) 
{
...
static inline void 
adsr_setSustainLevel(Adsr* self, sample_t level) 
{
...
static inline void 
adsr_setTargetRatioA(Adsr* self, sample_t targetRatio) 
{
...
static inline void 
adsr_setTargetRatioDR(Adsr* self, sample_t targetRatio) 
{
    if (targetRatio < 0.000000001)
        targetRatio = 0.000000001;  // -180 dB
